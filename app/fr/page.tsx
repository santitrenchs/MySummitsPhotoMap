...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: t.meta_desc,
    type: "website",
    url: "https://www.peakadex.com/fr",
    siteName: "Peakadex",
    locale: "fr_FR",
    alternateLocale: ["es_ES", "en_US", "de_DE", "ca_ES"],
  ...
  alternates: {
    canonical: "https://www.peakadex.com/fr",
    languages: HREFLANG,
  },
};
...
export default async function FrPage() {
  ...
  return <LandingPage stats={stats} peakCounts={peakCounts} locale="fr" />;
}
