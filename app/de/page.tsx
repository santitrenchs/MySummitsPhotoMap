...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: t.meta_desc,
    type: "website",
    url: "https://www.peakadex.com/de",
    siteName: "Peakadex",
    locale: "de_DE",
    alternateLocale: ["es_ES", "en_US", "fr_FR", "ca_ES"],
  ...
  alternates: {
    canonical: "https://www.peakadex.com/de",
    languages: HREFLANG,
  },
};
...
export default async function DePage() {
  ...
  return <LandingPage stats={stats} peakCounts={peakCounts} locale="de" />;
}
