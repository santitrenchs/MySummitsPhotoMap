...
- **Mythic card treatment** (front): gold **"MYTHIC"** badge top-left, **"1 Cairn ·" + "+N EP"** reward (cairn glyph), and a **pulsing gold glow** (animated colored shadow). Web + Android match (`card_mythic`, Android `cards_card_cairn`, `CairnGlyph`).
