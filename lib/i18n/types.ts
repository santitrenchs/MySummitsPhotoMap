...
export type Dict = {
  ...
  newAscent_clickOrDrag: string; newAscent_maxSize: string; newAscent_selectFiles: string; photo_tooLarge: string;
  newAscent_savingAscent: string; newAscent_uploadingPhoto: string;
  newAscent_savingTags: string; newAscent_save: string; newAscent_saveChanges: string; newAscent_delete: string;
  newAscent_saveWithPhotos: string; newAscent_photoFailed: string;
  newAscent_tagged: string;
  newAscent_duplicate: string;
  newAscent_discardTitle: string; newAscent_discardMessage: string; newAscent_discard: string;
  ...
  challenges_countActive: string;
  challenges_countAvailable: string;
  challenges_progress: string;
  challenges_remaining: string;
  challenges_completed: string;
  challenges_peaksCount: string;
  challenges_emptyTitle: string;
  challenges_emptyBody: string;
  challenges_noSearchMatch: string;
  ...
  home_chartTitle: string; home_chartAscended: string;
