...
export const de: Dict = {
  ...
  map_viewAscent: "Capture ansehen", map_viewAscents: "Capture ansehen",
  ...
  map_north: "Nach Norden ausrichten",
  map_facingNorth: "Karte zeigt nach Norden",
  map_showSearch: "Suche einblenden",
  map_hideSearch: "Suche ausblenden",
  map_layers: "Ebenen",
  map_myLocation: "Mein Standort",
  ...
  map_geoDeniedIn: "Erlaube den Standortzugriff unter Einstellungen > {browser} > Ort.",
  map_geoDenied: "Erlaube den Standortzugriff in den Browsereinstellungen.",
  map_geoFailed: "Dein Standort konnte nicht ermittelt werden.",
  ...
  photo_tooLarge: "Das Foto überschreitet das 10 MB-Limit",
  ...
  people_reconcile: "Mit registriertem Freund verknüpfen", people_reconcileTitle: "Mit registriertem Nutzer verknüpfen",
  people_reconcileSelect: "Freund auswählen", people_reconcileConfirm: "Verknüpfen",
  people_reconcileNoFriends: "Noch keine akzeptierten Freunde", people_reconcileLinked: "Verknüpft",
  ...
  delacc_title: "Konto löschen",
  delacc_intro: "Du kannst dein Peakadex-Konto jederzeit löschen. Das ist unwiderruflich: Gelöschtes lässt sich nicht wiederherstellen.",
  delacc_inAppTitle: "Wenn du die App installiert hast",
  delacc_inAppBody: "Öffne <strong>Einstellungen</strong> und tippe unten auf <strong>Konto löschen</strong>. Auf Android und im Web funktioniert es gleich. Du wirst gebeten, mit einem Wort zu bestätigen, und die Löschung erfolgt sofort.",
  delacc_noAppTitle: "Wenn du sie bereits deinstalliert hast",
  delacc_noAppBody: "Schreib uns an <a href='mailto:{email}'>{email}</a> von derselben Adresse, mit der du dich registriert hast, und bitte um die Löschung deines Kontos. Es muss diese Adresse sein: nur so können wir prüfen, dass das Konto dir gehört.",
  delacc_deletedTitle: "Was gelöscht wird",
  ...
  delacc_timingTitle: "Wie lange es dauert",
  delacc_timingBody: "Aus der App heraus erfolgt die Löschung sofort. Per E-Mail bearbeiten wir die Anfrage innerhalb von höchstens 30 Tagen, wie es die Datenschutz-Grundverordnung verlangt.",
  settings_help: "Hilfe",
  settings_contactSupport: "Support kontaktieren",
  settings_contactSupportAction: "Schreiben",
  ...
  settings_changePasswordGoogleNote: "Google aktiv · du kannst dich auch ohne Passwort anmelden",
  ...
  auth_continueWithGoogle: "Mit Google fortfahren",
  auth_oauthError: "Anmeldung mit Google fehlgeschlagen. Bitte versuche es erneut.",
  ...
  tag_notThisPerson: "Nicht diese Person",
  ...
  challenges_countActive: "{n} aktive Challenge{n,plural,=1{}other{s}}",
  challenges_countAvailable: "{n} verfügbar",
  challenges_progress: "{done}/{total}",
  challenges_remaining: "Noch {n} Gipfel",
  challenges_completed: "Challenge geschafft!",
  challenges_peaksCount: "{n} Gipfel",
  challenges_emptyTitle: "Du verfolgst noch keine Challenge",
  challenges_emptyBody: "Challenges sind Gipfellisten zum Abarbeiten. Tippe auf „Hinzufügen“, um die verfügbaren zu sehen.",
  challenges_noSearchMatch: "Keine deiner Challenges passt zu dieser Suche.",
  ...
  challenges_joinedBadge: "Dabei",
  challenges_detailPending: "{n} offen",
  challenges_detailHighest: "Höchster",
  challenges_searchPeak: "Gipfel suchen…",
  challenges_viewOnMap: "Im Atlas ansehen",
  challenges_atlasExit: "Challenge verlassen",
  challenges_filters: "Filter",
  challenges_filterStatus: "Status",
  challenges_sortComarca: "Region",
  challenges_filterAll: "Alle",
  challenges_filterDone: "Erledigt",
  challenges_filterPending: "Offen",
  challenges_filterShow: "{n} Gipfel anzeigen",
  challenges_logAscent: "Besteigung eintragen",
  challenges_sectionCollection: "Deine Sammlung",
  challenges_noPeakMatch: "Kein Gipfel passt zu dieser Suche.",
  profile_stat_photos: "Fotos",
  profile_timesClimbed: "×{n}",
  profile_noAscents: "Noch keine Besteigungen",

  profile_collection_title: "Deine Sammlung",
  profile_collection_unique: "einzigartig",
  profile_collection_ascents: "Besteigungen",
  profile_collection_rarities: "Raritäten",
  profile_trophy_mostClimbed: "Meistbestiegener Gipfel",
  profile_trophy_highest: "Höchster Gipfel",
  profile_trophy_rarest: "Seltenste Rarität",
  profile_trophy_recent: "Letzter Gipfel",
  profile_trophy_label_ascents: "Besteigungen",
  profile_trophy_label_altitude: "Höhe",
  profile_trophy_label_species: "Art",
  profile_trophy_label_conquered: "Bezwungen",
  profile_filter_button: "Filter",
  profile_filter_searchPlaceholder: "Gipfel suchen…",
  profile_filter_title: "Gipfel filtern",
  profile_filter_rarity: "Rarität",
  profile_filter_range: "Gebirge",
  profile_filter_sort: "Sortierung",
  profile_filter_clearAll: "Alles löschen",
  profile_filter_showN: "{n} {n,plural,=1{Gipfel}other{Gipfel}} anzeigen",
  profile_sort_altDesc: "Höhe ↓",
  profile_sort_altAsc: "Höhe ↑",
  profile_sort_countDesc: "Meistbestiegen",
  profile_sort_recent: "Neueste",
  profile_sort_alpha: "Alphabetisch",
  profile_emptyFiltered_title: "Kein Gipfel gefunden",
  profile_emptyFiltered_body: "Versuche weniger Filter.",
  profile_photos_searchPlaceholder: "Foto nach Gipfel suchen…",
  profile_photos_searchTaggedPlaceholder: "Fotos suchen, auf denen du erscheinst…",
  profile_photos_countLabel: "{n} {n,plural,=1{Foto}other{Fotos}}",
  profile_photos_tagAll: "Alle",
  profile_catalog_label: "Katalog · Gipfel",
  profile_catalog_peaks: "Gipfel",
  profile_catalog_ascents: "Besteigungen",
  profile_catalog_highest: "Höchster",
  ...
  home_ranking: "Deine Seilschaft", home_youAre: "du", home_ropeTeamSub: "Klettert zusammen. Verdient EP. Sammelt CS.", home_yourPosition: "Deine Position", home_epToSecure: "→ {n} EP um Platz 1 zu sichern", home_epToBeat: "→ {n} EP um {name} zu schlagen", home_epBehind: "{n} EP hinter dir",
  home_motivationBeat: "Noch {n} Gipfel{n,plural,=1{}other{}} bis du {name} überholst",
  home_motivationFirst: "Du bist #1 🏆! Weiter so!",
  home_motivationNoFriends: "Der Weg ist schöner, wenn man ihn teilt.",
  home_motivationNoFriendsSub: "Finde dein Seilteam, erlebe jeden Aufstieg neu und wachst gemeinsam in den Bergen.",
  home_addFriends: "Freunde hinzufügen",
  home_recentAscents: "Deine letzten Gipfel", home_seeAll: "Alle ansehen",
  home_friendsActivity: "Aktivität deiner Seilschaft", home_noFriendActivity: "Keine aktuelle Aktivität deiner Seilschaft",
  ...
  home_level6Quote: "Der Berg ist kein Spiel — er ist eine Gelegenheit herauszufinden, wer man wirklich ist.",
  home_maxLevelHint: "Legende des Bergsteigens",
  home_heroSubtitle: "Dein Weg in den Bergen",
  home_metricPeaks: "Gipfel", home_metricAscents: "Besteigungen", home_metricMaxAlt: "max. Höhe",
  home_levelNext: "{current}/{next} Gipfel für nächstes Level",
  home_maxLevel: "Max. Level! 🏆",
  home_inviteFriends: "Freunde einladen",
  home_motivationDefend: "{name} ist nur {n} Gipfel dahinter — weiter so!",
  home_progression: "Fortschritt",
  home_altReq: "{alt} erreichen",
  home_altReqMulti: "{n} Gipfel über {alt}",
  home_heroForLevel: "für {name}",
  home_levelProgress: "{current} / {total} Gipfel",
  home_levelNeedSummits: "Noch {n} Gipfel",
  home_seeAllLevels: "Alle Level anzeigen →",
  home_hideLevels: "Weniger anzeigen",
  ...
  auth_emailExists: "Ein Konto mit dieser E-Mail existiert bereits.",
  auth_createAccountSubmit: "Konto erstellen und eintreten →",
  auth_haveCode: "Hast du einen Zugangscode?",
  auth_legal_required: "Ich akzeptiere die {terms} und die {privacy}.",
  auth_legal_terms: "Nutzungsbedingungen",
  auth_legal_privacy: "Datenschutzrichtlinie",
  auth_legal_marketing: "Ich möchte Peakadex-News und Mitteilungen erhalten (optional)",
  auth_legal_mustAccept: "Du musst die Nutzungsbedingungen und Datenschutzrichtlinie akzeptieren, um fortzufahren.",
  auth_accept_title: "Willkommen bei Peakadex",
  auth_accept_subtitle: "Um Peakadex weiter nutzen zu können, benötigen wir deine Zustimmung zu den Nutzungsbedingungen und der Datenschutzrichtlinie.",
  auth_accept_cta: "Akzeptieren und weiter",
  auth_accept_accepting: "Wird gespeichert…",
  auth_accept_signOut: "Abmelden",
  legal_back: "← Zurück zur Startseite",
  legal_termsTitle: "Allgemeine Geschäftsbedingungen",
  legal_privacyTitle: "Datenschutzerklärung",
  legal_cookiesTitle: "Cookie-Richtlinie",
  legal_termsLink: "Nutzungsbedingungen",
  legal_privacyLink: "Datenschutzerklärung",
  legal_cookiesLink: "Cookie-Richtlinie",
  legal_lastUpdated: "Letzte Aktualisierung: {date} · Version {version}",
  ...
  map_onboarding_rarities: "Seltenheitsstufen",
