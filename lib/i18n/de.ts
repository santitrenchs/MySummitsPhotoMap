...
export const de: Dict = {
  ...
  challenges_joinedBadge: "Bereits dabei",
  challenges_detailEyebrow: "Challenge · Fortschritt",
  ...
  challenges_lastLabel: "Zuletzt",
  challenges_noAscent: "Noch nicht bestiegen",
  ...
  home_altReq: "{m}m erreichen",
  home_altReqMulti: "{n} Gipfel über {m}m",
