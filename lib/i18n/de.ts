...
export const de: Dict = {
  ...
  auth_legal_marketing: "Ich möchte Peakadex-News und Tipps erhalten (optional)",
  auth_legal_mustAccept: "Du musst die Nutzungsbedingungen und Datenschutzrichtlinie akzeptieren, um fortzufahren.",
  auth_accept_title: "Wir haben unsere Bedingungen aktualisiert",
  auth_accept_subtitle: "Um Peakadex weiter zu nutzen, musst du die aktualisierten Nutzungsbedingungen und Datenschutzrichtlinie akzeptieren.",
