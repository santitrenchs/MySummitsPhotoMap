...
export const es: Dict = {
  ...
  map_north: "Orientar al norte",
  map_facingNorth: "El mapa mira al norte",
  map_showSearch: "Mostrar buscador",
  map_hideSearch: "Ocultar buscador",
  map_layers: "Capas",
  map_myLocation: "Mi ubicación",
  map_mapType: "Tipo de mapa",
  map_layerNormal: "Normal",
  map_layerRelief: "Relieve",
  map_layerSatellite: "Satélite",
  map_layerTrails: "Senderos",
  map_layerHuts: "Refugios",
  map_geoUnsupported: "Tu navegador no soporta geolocalización.",
  map_geoDeniedIn: "Permite el acceso a tu ubicación en Ajustes > {browser} > Ubicación.",
  map_geoDenied: "Permite el acceso a tu ubicación en los ajustes del navegador.",
  map_geoFailed: "No se pudo obtener tu ubicación.",
  ...
  newAscent_saveChanges: "Guardar", newAscent_delete: "Eliminar ascensión",
  ...
  detail_editPhoto: "Editar foto", detail_tagPeople: "Etiquetar", detail_reCrop: "Re-encuadrar", detail_changePhoto: "Cambiar foto",
  ...
  delacc_title: "Eliminar tu cuenta",
  delacc_intro: "Puedes eliminar tu cuenta de Peakadex cuando quieras. Es irreversible: no hay forma de recuperar lo borrado.",
  delacc_inAppTitle: "Si tienes la aplicación instalada",
  delacc_inAppBody: "Abre <strong>Ajustes</strong> y pulsa <strong>Eliminar cuenta</strong>, al final de la pantalla. Funciona igual en Android y en la web. Se te pedirá confirmar escribiendo una palabra, y el borrado es inmediato.",
  delacc_noAppTitle: "Si ya la has desinstalado",
  delacc_noAppBody: "Escríbenos a <a href='mailto:{email}'>{email}</a> desde la misma dirección con la que te registraste, pidiendo la eliminación de tu cuenta. Necesitamos que sea esa dirección: es lo único que nos permite comprobar que la cuenta es tuya.",
  delacc_deletedTitle: "Qué se elimina",
  ...
  delacc_timingTitle: "Cuánto tarda",
  delacc_timingBody: "Desde la aplicación, el borrado es inmediato. Por correo electrónico, atendemos la solicitud en un plazo máximo de 30 días, como exige el Reglamento General de Protección de Datos.",
  settings_help: "Ayuda",
  settings_contactSupport: "Contactar con soporte",
  settings_contactSupportAction: "Escribir",
  ...
  challenges_countActive: "{n} reto{n,plural,=1{}other{s}} activo{n,plural,=1{}other{s}}",
  challenges_countAvailable: "{n} disponible{n,plural,=1{}other{s}}",
  challenges_progress: "{done}/{total}",
  challenges_remaining: "Quedan {n} cima{n,plural,=1{}other{s}}",
  challenges_completed: "¡Reto completado!",
  challenges_peaksCount: "{n} cima{n,plural,=1{}other{s}}",
  challenges_emptyTitle: "Todavía no sigues ningún reto",
  challenges_emptyBody: "Los retos son listas de cimas para ir completando. Toca «Añadir» para ver los disponibles.",
  challenges_noSearchMatch: "Ningún reto tuyo coincide con la búsqueda.",
  ...
  challenges_filterShow: "Ver {n} {n,plural,=1{cima}other{cimas}}",
  challenges_logAscent: "Registrar ascensión",
  challenges_sectionCollection: "Tu colección",
  challenges_noPeakMatch: "Ninguna cima coincide con la búsqueda.",
  ...
  home_altReq: "Superar los {alt}",
  home_altReqMulti: "{n} cimas sobre {alt}",
  ...
  card_peakCapture: "Peak Capture", card_mythic: "MYTHIC", card_cordada_label: "Tu Cordada:", card_cordada_label_other: "Cordada:", share_tapToFlip: "Toca la carta para ver el reverso",
  card_rarity: "Rareza", card_altitude: "Altitud", card_reward: "Recompensa",
  capture_reveal_captured: "¡Cima capturada!",
