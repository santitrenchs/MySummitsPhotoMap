...
export const es: Dict = {
  ...
  auth_legal_marketing: "Quiero recibir novedades y consejos sobre Peakadex (opcional)",
  auth_legal_mustAccept: "Debes aceptar los términos y la política de privacidad para continuar.",
  auth_accept_title: "Hemos actualizado los términos",
  auth_accept_subtitle: "Para seguir usando Peakadex debes aceptar los nuevos términos y condiciones y la política de privacidad.",
  auth_accept_cta: "Acepto y continuar",
