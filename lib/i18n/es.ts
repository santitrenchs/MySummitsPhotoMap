...
export const es: Dict = {
  ...
  nav_map: "Mapa", nav_ascents: "Ascensiones", nav_people: "Personas",
  ...
  ascents_title: "Ascensiones", ascents_search: "🔍  Busca cimas, rutas, personas…",
  ascents_filters: "Filtros", ascents_allYears: "Todos los años", ascents_allPeople: "Todas las personas",
  ...
  ascents_stat_peaks: "cimas", ascents_stat_people: "personas",

  people_title: "Personas", people_search: "🔍  Buscar personas…",
  people_editPerson: "Editar persona", people_fullName: "Nombre completo",
  people_lastClimb: "Última ascensión:", people_noMatch: "Ninguna persona coincide con la búsqueda",
  ...
  people_stat_people: "personas", people_stat_photos: "fotos", people_stat_ascents: "ascensiones",
  ...
  settings_autoSuggest: "Sugerir personas automáticamente", settings_autoSuggestDesc: "Sugiere nombres para caras reconocidas",
  ...
  tag_detecting: "Detectando caras…", tag_tagPeople: "Etiquetar personas",
  tag_tagPeopleFound: "Etiquetar personas · {n} detectadas", tag_whoIsThis: "¿Quién es?",
  tag_looksLike: "Parece", tag_confirmCta: "Confirmar ✓",
  tag_searchOrType: "Busca o escribe un nombre nuevo…", tag_createNew: "Crear nueva persona",
