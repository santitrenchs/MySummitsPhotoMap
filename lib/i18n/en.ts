...
export const en: Dict = {
  ...
  map_viewAscent: "View capture", map_viewAscents: "View capture",
  ...
  map_north: "Face north",
  map_facingNorth: "Map is facing north",
  map_showSearch: "Show search",
  map_hideSearch: "Hide search",
  map_layers: "Layers",
  map_myLocation: "My location",
  ...
  map_geoDeniedIn: "Allow location access in Settings > {browser} > Location.",
  map_geoDenied: "Allow location access in your browser settings.",
  map_geoFailed: "Couldn't get your location.",

  peak_notFound: "No peaks found", peak_moreResults: "+{n} more · type to filter",
  ...
  photo_tooLarge: "Photo exceeds the 10 MB limit",
  ...
  filter_title: "Explore ascents", filter_sectionExplore: "Explore",
  filter_mine: "My summits", filter_friends: "My team", filter_person: "By a person", filter_withMe: "With me",
  filter_searchPerson: "Search person…",
  filter_sectionRarity: "Rarity", filter_allRarities: "All",
  filter_sectionWhen: "When", filter_lastMonth: "Last month", filter_thisYear: "This year", filter_allTime: "All time",
  filter_sectionSort: "Sort by",
  filter_results: "Show {n} ascent{n,plural,=1{}other{s}}", filter_uniquePeaks: "{n} unique peak{n,plural,=1{}other{s}}",
  ...
  delacc_title: "Delete your account",
  delacc_intro: "You can delete your Peakadex account whenever you want. It is irreversible: there is no way to recover what is deleted.",
  delacc_inAppTitle: "If you have the app installed",
  delacc_inAppBody: "Open <strong>Settings</strong> and tap <strong>Delete account</strong> at the bottom of the screen. It works the same on Android and on the web. You will be asked to confirm by typing a word, and the deletion is immediate.",
  delacc_noAppTitle: "If you have already uninstalled it",
  delacc_noAppBody: "Email us at <a href='mailto:{email}'>{email}</a> from the same address you signed up with, asking for your account to be deleted. It has to be that address: it is the only thing that lets us verify the account is yours.",
  delacc_deletedTitle: "What is deleted",
  ...
  delacc_timingTitle: "How long it takes",
  delacc_timingBody: "From the app, deletion is immediate. By email, we handle the request within a maximum of 30 days, as required by the General Data Protection Regulation.",
  settings_help: "Help",
  settings_contactSupport: "Contact support",
  settings_contactSupportAction: "Write",
  ...
  settings_changePasswordGoogleNote: "Google active · you can also sign in without a password",
  ...
  auth_oauthError: "Could not sign in with Google. Please try again.",
  ...
  challenges_add: "Add",
  challenges_countActive: "{n} active challenge{n,plural,=1{}other{s}}",
  challenges_countAvailable: "{n} available",
  challenges_progress: "{done}/{total}",
  challenges_remaining: "{n} summit{n,plural,=1{}other{s}} to go",
  challenges_completed: "Challenge completed!",
  challenges_peaksCount: "{n} summit{n,plural,=1{}other{s}}",
  challenges_emptyTitle: "You are not following any challenge yet",
  challenges_emptyBody: "Challenges are lists of summits to work through. Tap “Add” to see the available ones.",
  challenges_noSearchMatch: "None of your challenges match that search.",
  ...
  challenges_filterAll: "All",
  challenges_filterDone: "Done",
  challenges_filterPending: "Pending",
  challenges_filterShow: "Show {n} {n,plural,=1{summit}other{summits}}",
  challenges_logAscent: "Log ascent",
  challenges_sectionCollection: "Your collection",
  challenges_noPeakMatch: "No summit matches that search.",
  profile_stat_photos: "photos",
  profile_timesClimbed: "×{n}",
  profile_noAscents: "No ascents logged yet",

  profile_collection_title: "Your collection",
  profile_collection_unique: "unique",
  profile_collection_ascents: "ascents",
  profile_collection_rarities: "rarities",
  profile_trophy_mostClimbed: "Most climbed peak",
  profile_trophy_highest: "Highest peak",
  profile_trophy_rarest: "Rarest rarity",
  profile_trophy_recent: "Latest peak",
  profile_trophy_label_ascents: "Ascents",
  profile_trophy_label_altitude: "Altitude",
  profile_trophy_label_species: "Species",
  profile_trophy_label_conquered: "Conquered",
  profile_filter_button: "Filters",
  profile_filter_searchPlaceholder: "Search peak…",
  profile_filter_title: "Filter your peaks",
  profile_filter_rarity: "Rarity",
  profile_filter_range: "Mountain range",
  profile_filter_sort: "Sort",
  profile_filter_clearAll: "Clear all",
  profile_filter_showN: "Show {n} {n,plural,=1{peak}other{peaks}}",
  profile_sort_altDesc: "Altitude ↓",
  profile_sort_altAsc: "Altitude ↑",
  profile_sort_countDesc: "Most climbed",
  profile_sort_recent: "Most recent",
  profile_sort_alpha: "Alphabetical",
  profile_emptyFiltered_title: "No peaks match",
  profile_emptyFiltered_body: "Try fewer filters.",
  profile_photos_searchPlaceholder: "Search photo by peak…",
  profile_photos_searchTaggedPlaceholder: "Search photos you appear in…",
  profile_photos_countLabel: "{n} {n,plural,=1{photo}other{photos}}",
  profile_photos_tagAll: "All",
  profile_catalog_label: "Catalog · Peaks",
  profile_catalog_peaks: "peaks",
  profile_catalog_ascents: "ascents",
  profile_catalog_highest: "Highest",
  ...
  home_ranking: "Your rope team", home_youAre: "you", home_ropeTeamSub: "Climb together. Earn EP. Collect CS.", home_yourPosition: "Your position", home_epToSecure: "→ {n} EP to secure #1", home_epToBeat: "→ {n} EP to beat {name}", home_epBehind: "{n} EP behind you",
  home_motivationBeat: "{n} more summit{n,plural,=1{}other{s}} to beat {name}",
  home_motivationFirst: "You're #1 🏆 Keep climbing!",
  home_motivationNoFriends: "Your journey is better shared.",
  home_motivationNoFriendsSub: "Find your rope team, relive each ascent and grow together in the mountains.",
  ...
  home_level6Quote: "The mountain is not a game — it is an opportunity to discover who you really are.",
  ...
  home_altReq: "Reach {alt}",
  home_altReqMulti: "{n}× above {alt}",
  home_heroForLevel: "for {name}",
  ...
  home_chartTitle: "Last 6 months", home_chartAscended: "ascended",
  ...
  auth_legal_required: "I accept the {terms} and the {privacy}.",
  auth_legal_terms: "Terms and Conditions",
  auth_legal_privacy: "Privacy Policy",
  auth_legal_marketing: "I'd like to receive Peakadex news and updates (optional)",
  auth_legal_mustAccept: "You must accept the terms and privacy policy to continue.",
  auth_accept_title: "Welcome to Peakadex",
  auth_accept_subtitle: "To continue using Peakadex, we need you to accept the Terms and Conditions and Privacy Policy.",
  auth_accept_cta: "Accept and continue",
  auth_accept_accepting: "Saving…",
  auth_accept_signOut: "Sign out",
  legal_back: "← Back to home",
  legal_termsTitle: "Terms and Conditions",
  legal_privacyTitle: "Privacy Policy",
  legal_cookiesTitle: "Cookie Policy",
  legal_termsLink: "Terms of use",
  legal_privacyLink: "Privacy policy",
  legal_cookiesLink: "Cookie policy",
  legal_lastUpdated: "Last updated: {date} · Version {version}",
