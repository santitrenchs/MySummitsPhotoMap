...
export const ca: Dict = {
  ...
  nav_map: "Mapa", nav_ascents: "Ascensions", nav_people: "Persones",
  ...
  ascents_title: "Ascensions", ascents_search: "🔍  Cerca cims, rutes, persones…",
  ascents_filters: "Filtres", ascents_allYears: "Tots els anys", ascents_allPeople: "Totes les persones",
  ...
  ascents_stat_peaks: "cims", ascents_stat_people: "persones",

  people_title: "Persones", people_search: "🔍  Cercar persones…",
  people_editPerson: "Editar persona", people_fullName: "Nom complet",
  people_lastClimb: "Última ascensió:", people_noMatch: "Cap persona coincideix amb la cerca",
  ...
  people_stat_people: "persones", people_stat_photos: "fotos", people_stat_ascents: "ascensions",
  ...
  settings_autoSuggest: "Suggerir persones automàticament", settings_autoSuggestDesc: "Suggereix noms per a cares reconegudes",
  ...
  tag_detecting: "Detectant cares…", tag_tagPeople: "Etiquetar persones",
  tag_tagPeopleFound: "Etiquetar persones · {n} detectades", tag_whoIsThis: "Qui és?",
  tag_looksLike: "Sembla", tag_confirmCta: "Confirmar ✓",
  tag_searchOrType: "Cerca o escriu un nom nou…", tag_createNew: "Crear nova persona",
