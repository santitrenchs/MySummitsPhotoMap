...
export const ca: Dict = {
  ...
  home_level5Quote: "La muntanya més alta i difícil sempre és la que portem dins. Perquè, al cap i a la fi, som nosaltres mateixos qui creem les nostres muntanyes i el desig de superar-les.",
