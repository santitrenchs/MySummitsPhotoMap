...
export const ca: Dict = {
  ...
  home_ranking: "Rànquing d'amics", home_youAre: "tu",
  ...
  home_recentAscents: "Ascensions recents", home_seeAll: "Veure-les totes",
  home_friendsActivity: "Activitat d'amics", home_noFriendActivity: "Sense activitat recent dels amics",
