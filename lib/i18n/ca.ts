...
export const ca: Dict = {
  ...
  auth_legal_marketing: "Vull rebre novetats i consells de Peakadex (opcional)",
  auth_legal_mustAccept: "Has d'acceptar els termes i la política de privadesa per continuar.",
  auth_accept_title: "Hem actualitzat els termes",
  auth_accept_subtitle: "Per continuar usant Peakadex has d'acceptar els nous termes i condicions i la política de privadesa.",
  auth_accept_cta: "Accepto i continua",
