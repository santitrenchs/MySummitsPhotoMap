...
export const fr: Dict = {
  ...
  map_north: "Orienter au nord",
  map_facingNorth: "La carte est orientée au nord",
  map_showSearch: "Afficher la recherche",
  map_hideSearch: "Masquer la recherche",
  map_layers: "Calques",
  map_myLocation: "Ma position",
  ...
  map_geoDeniedIn: "Autorise l'accès à ta position dans Réglages > {browser} > Position.",
  map_geoDenied: "Autorise l'accès à ta position dans les réglages du navigateur.",
  map_geoFailed: "Impossible d'obtenir ta position.",
  ...
  delacc_title: "Supprimer votre compte",
  delacc_intro: "Vous pouvez supprimer votre compte Peakadex quand vous le souhaitez. C’est irréversible : il n’y a aucun moyen de récupérer ce qui est supprimé.",
  delacc_inAppTitle: "Si vous avez l’application installée",
  delacc_inAppBody: "Ouvrez <strong>Paramètres</strong> et appuyez sur <strong>Supprimer le compte</strong>, en bas de l’écran. Cela fonctionne de la même façon sur Android et sur le web. Il vous sera demandé de confirmer en saisissant un mot, et la suppression est immédiate.",
  delacc_noAppTitle: "Si vous l’avez déjà désinstallée",
  delacc_noAppBody: "Écrivez-nous à <a href='mailto:{email}'>{email}</a> depuis l’adresse avec laquelle vous vous êtes inscrit, en demandant la suppression de votre compte. Il faut que ce soit cette adresse : c’est la seule chose qui nous permet de vérifier que le compte est bien le vôtre.",
  delacc_deletedTitle: "Ce qui est supprimé",
  ...
  delacc_timingTitle: "Délai",
  delacc_timingBody: "Depuis l’application, la suppression est immédiate. Par e-mail, nous traitons la demande dans un délai maximum de 30 jours, comme l’exige le Règlement général sur la protection des données.",
  settings_help: "Aide",
  settings_contactSupport: "Contacter le support",
  settings_contactSupportAction: "Écrire",
  ...
  auth_oauthError: "Connexion avec Google impossible. Réessaie.",
  ...
  challenges_emptyBody: "Les défis sont des listes de sommets à compléter. Touche « Ajouter » pour voir les défis disponibles.",
  challenges_noSearchMatch: "Aucun de tes défis ne correspond à cette recherche.",
  ...
  challenges_joinedBadge: "Rejoint",
  ...
  challenges_filterAll: "Tous",
  challenges_filterDone: "Faits",
  challenges_filterPending: "À faire",
  challenges_filterShow: "Voir {n} {n,plural,=1{sommet}other{sommets}}",
  challenges_logAscent: "Enregistrer l'ascension",
  challenges_sectionCollection: "Ta collection",
  challenges_noPeakMatch: "Aucun sommet ne correspond à cette recherche.",
  ...
  home_altReq: "Atteindre {alt}",
  home_altReqMulti: "{n} sommet{n,plural,=1{}other{s}} au-dessus de {alt}",
  ...
  home_chartTitle: "6 derniers mois", home_chartAscended: "gravis",
