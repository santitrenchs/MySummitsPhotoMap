...
export const fr: Dict = {
  ...
  nav_map: "Carte", nav_ascents: "Ascensions", nav_people: "Personnes",
  ...
  ascents_title: "Ascensions", ascents_search: "🔍  Chercher sommets, itinéraires, personnes…",
  ascents_filters: "Filtres", ascents_allYears: "Toutes les années", ascents_allPeople: "Toutes les personnes",
  ...
  ascents_stat_peaks: "sommets", ascents_stat_people: "personnes",

  people_title: "Personnes", people_search: "🔍  Chercher des personnes…",
  people_editPerson: "Modifier la personne", people_fullName: "Nom complet",
  people_lastClimb: "Dernière ascension :", people_noMatch: "Aucune personne ne correspond",
  ...
  people_stat_people: "personnes", people_stat_photos: "photos", people_stat_ascents: "ascensions",
  ...
  settings_autoSuggest: "Suggérer des personnes", settings_autoSuggestDesc: "Proposer des noms pour les visages reconnus",
  ...
  tag_detecting: "Détection des visages…", tag_tagPeople: "Identifier les personnes",
  tag_tagPeopleFound: "Identifier les personnes · {n} détectées", tag_whoIsThis: "Qui est-ce ?",
  tag_looksLike: "Ressemble à", tag_confirmCta: "Confirmer ✓",
  tag_searchOrType: "Chercher ou saisir un nouveau nom…", tag_createNew: "Créer une nouvelle personne",
