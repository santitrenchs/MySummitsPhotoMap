...
export const fr: Dict = {
  ...
  auth_legal_marketing: "Je souhaite recevoir les actualités et conseils Peakadex (facultatif)",
  auth_legal_mustAccept: "Vous devez accepter les conditions et la politique de confidentialité pour continuer.",
  auth_accept_title: "Nos conditions ont été mises à jour",
  auth_accept_subtitle: "Pour continuer à utiliser Peakadex, vous devez accepter les nouvelles conditions d'utilisation et la politique de confidentialité.",
