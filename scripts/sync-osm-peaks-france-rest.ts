/**
 * sync-osm-peaks-france-rest.ts
 *
 * Safe OSM sync for remaining French peaks (Massif Central, Jura, Vosges,
 * Nord France, Corsica). Same 4-step logic as sync-osm-peaks-france.ts.
 *
 * Input:  /tmp/france-rest-peaks.ndjson  (produced by fetch-osm-peaks-france-rest.ts)
 * Run:
 *   DATABASE_URL="..." npx tsx scripts/sync-osm-peaks-france-rest.ts [--dry-run]
 */
...
const NDJSON  = "/tmp/france-rest-peaks.ndjson";
const BATCH   = 500;
